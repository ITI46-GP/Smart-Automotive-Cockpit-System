...
Q_IMPORT_QML_PLUGIN(BottomLayerPlugin)
Q_IMPORT_QML_PLUGIN(Digital_Cluster_DesignStudioPlugin)
Q_IMPORT_QML_PLUGIN(Digital_Cluster_DesignStudioContentPlugin)
Q_IMPORT_QML_PLUGIN(Digital_Cluster_DesignStudioContent_Content_AreaPlugin)
Q_IMPORT_QML_PLUGIN(GaugePlugin)

const char mainQmlFile[] = "qrc:/qt/qml/Digital_Cluster_DesignStudioContent/App.qml";
